...
# HELMET GLM-4-9B-Chat FlexPrefill 8k-64k 评估脚本 - gamma=0.95, tau=0.1
echo "Running HELMET with GLM-4-9B-Chat FlexPrefill (8k-64k contexts, gamma=0.95, tau=0.1)"
...
echo "Running 8k-64k versions with GLM-4-9B-Chat FlexPrefill (gamma=$GAMMA, tau=$TAU, stride=$STRIDE)"
...
echo "GLM-4 FlexPrefill 8k-64k (gamma=$GAMMA, tau=$TAU) evaluation completed! Results in $OUTPUT_DIR"
