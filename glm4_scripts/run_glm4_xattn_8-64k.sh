...
# HELMET GLM-4-9B-Chat XAttention 8k-64k 评估脚本
echo "Running HELMET with GLM-4-9B-Chat XAttention (8k-64k contexts)"
...
echo "Running 8k-64k versions with GLM-4-9B-Chat XAttention (threshold=$THRESHOLD, stride=$STRIDE)"
...
echo "GLM-4 XAttention 8k-64k (threshold=$THRESHOLD) evaluation completed! Results in $OUTPUT_DIR"
