...
# GPT-4评估 - Llama Summarization 任务
echo "🤖 Running GPT-4 evaluation for Llama Summarization tasks..."
...
for model in "${models[@]}"; do
    ...
    echo "📊 评估 Llama $model summarization 结果..."
...
echo "✅ Llama Summarization GPT-4 评估完成!"
echo "📁 检查结果文件: llama_output/*/summ/*-gpt4eval_o.json"
