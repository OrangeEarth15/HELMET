...
def parse_arguments():
    ...
    parser.add_argument("--attn_use_simple", type=int, default=0, choices=[0, 1, 2, 3, 4, 5, 6, 7], help="simple attention version: 0=disabled, 1=v1, 2=v2, 3=v3, 4=v4, 5=v5, 6=v6 (golden ratio selection + temperature), 7=v7 (layer + head robin selection combined)")
