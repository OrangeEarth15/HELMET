...
# GPT-4评估 - Qwen Long QA 任务
echo "🤖 Running GPT-4 evaluation for Qwen Long QA tasks..."
...
echo "✅ Qwen Long QA GPT-4 评估完成!"
echo "📁 检查结果文件: qwen_output/full_flashinfer/longqa/*-gpt4eval_o.json"
